...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    articlecontenttype: Schema.Attribute.Enumeration<
...
export interface ApiCalculatorCategoryTypeCalculatorCategoryType
  extends Struct.CollectionTypeSchema {
  collectionName: 'calculator_category_types';
  info: {
    displayName: 'CalculatorCategoryType';
    pluralName: 'calculator-category-types';
    singularName: 'calculator-category-type';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    calculatorcategory: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::calculator-category-type.calculator-category-type'
    > &
      Schema.Attribute.Private;
...
export interface ApiCalculatorCalculator extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    calculatorcategory: Schema.Attribute.Relation<
      'oneToOne',
      'api::calculator-category-type.calculator-category-type'
    >;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
...
export interface ApiDailyRateDailyRate extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    metalpurity: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiHomePageSectionStyleHomePageSectionStyle
  extends Struct.CollectionTypeSchema {
  collectionName: 'home_page_section_styles';
  info: {
    displayName: 'HomePageSectionStyle';
    pluralName: 'home-page-section-styles';
    singularName: 'home-page-section-style';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    itemtoshow: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-page-section-style.home-page-section-style'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sectionstyle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiHomepageSectionHomepageSection
  ...
  attributes: {
    ...
    enabled: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    homepagesectionstyle: Schema.Attribute.Relation<
      'oneToOne',
      'api::home-page-section-style.home-page-section-style'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiMetalPurityMetalPurity extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'MetalPurity';
    pluralName: 'metal-purities';
    singularName: 'metal-purity';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiUnitMeasureUnitMeasure extends Struct.CollectionTypeSchema {
  collectionName: 'unit_measures';
  info: {
    displayName: 'Unit Measure';
    pluralName: 'unit-measures';
    singularName: 'unit-measure';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    unitofmeasure: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    uomdescription: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::calculator-category-type.calculator-category-type': ApiCalculatorCategoryTypeCalculatorCategoryType;
      ...
      'api::home-page-section-style.home-page-section-style': ApiHomePageSectionStyleHomePageSectionStyle;
